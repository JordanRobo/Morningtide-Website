<script lang="ts">
	...
	const form = superForm(data.enquiryForm, {
		customValidity: true,
...
<div class="max-w-screen-lg mx-auto p-4 gap-4 my-16 space-y-12">
...
<div id='enquiry-form' class="bg-white -mb-8">
	<div class="container max-w-screen-lg flex flex-col mx-auto mt-8 py-12 space-y-12">
			...
			<div class="flex flex-col w-full md:w-1/3 gap-8">
				<form class='space-y-4 mx-auto md:mx-0' method="POST" action="/?/enquire" use:enhance>
					...
					<Fieldset class="fieldset" {form} name='enquiry_message'>
						...
						<Description class="max-w-80">By clicking the “Submit” button, you are agreeing to our
						<button
							onclick={(event) => (
