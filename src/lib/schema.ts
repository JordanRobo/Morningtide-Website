...
export const enquirySchema = v.object({
	form_id: v.string(),
	name: v.pipe(v.string(), v.nonEmpty("Please enter your name"), v.maxLength(100)),
	email: v.pipe(v.string(), v.nonEmpty("Please enter your email address"), v.email("Please enter a valid email address")),
	mobile: v.pipe(v.string(), v.nonEmpty("Please enter your mobile number")),
	enquiry_service: v.pipe(v.string(), v.nonEmpty("Please select a service")),
	enquiry_referrer: v.optional(v.pipe(v.string(), v.maxLength(100))),
