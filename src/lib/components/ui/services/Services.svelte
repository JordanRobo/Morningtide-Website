...
<div class="mt-10 flex flex-col items-center justify-center md:mt-20">
	<div class="flex flex-col items-center justify-center">
		...
		<span class="text-md mt-2 px-2 text-center md:mt-4 md:px-5 md:text-xl"
	...
	<div class="flex flex-col mt-10">
		<div class="carousel w-full gap-2">
			{#each services.service as item}
				<div id={item.id} class="carousel-item justify-center w-full md:w-1/2">
					<div
						class="card max-w-sm bg-white border transition duration-300 hover:-translate-y-1 flex flex-col rounded-bl-[120px]"
					>
		...
		<div class="hidden md:flex justify-center w-full pt-4 gap-2">
			<button class="btn btn-xs" on:click={() => navigateToSlide('1')}>1</button>
			<button class="btn btn-xs" on:click={() => navigateToSlide('3')}>2</button>
		</div>
		<div class="md:hidden flex justify-center w-full pt-4 gap-2">
			<button class="btn btn-xs" on:click={() => navigateToSlide('1')}>1</button>
			<button class="btn btn-xs" on:click={() => navigateToSlide('2')}>2</button>
			<button class="btn btn-xs" on:click={() => navigateToSlide('3')}>3</button>
			<button class="btn btn-xs" on:click={() => navigateToSlide('4')}>4</button>
		</div>
	</div>
</div>
