...
<footer class="footer p-10 bg-primary text-white md:grid-cols-6 md:space-x-4">
	<nav class="md:col-start-2 md:col-span-2">
		...
		<p class="font-body text-sm">
			Morningtide is a specialist consultancy working with independent school Boards, Principals,
			and their teams to create compelling strategy. We are dedicated to ensuring the success of
			your strategic execution, and our goal is to establish a sustained culture of strategic
			planning within your school long after our job is complete.
		</p>
	</nav>
	...
	<nav class="md:col-start-5 md:justify-self-end">
		...
		<a href="/services/customer-experience-audit" class="link link-hover font-body"
			>Customer Experience Audit</a
		>
		<a href="/services/financial-forecast-review" class="link link-hover font-body"
			>Financial Forecast Review</a
		>
...
<footer class="footer md:px-10 py-4 border-t bg-primary text-white border-accent md:grid-cols-6">
	...
	<nav class="place-self-center md:justify-self-end md:col-start-5">
		<div class="grid grid-flow-col gap-4">
			<a
				href="https://www.linkedin.com/in/stuart-robinson-mba/"
				aria-label="View Stuart Robinson's LinkedIn Profile"
			...
			>
			<a
				href="https://twitter.com/Morningtide_Go"
				aria-label="View Morningtide Consulting's Twitter Account"
				><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 448 512"
					><path
						fill="#ffffff"
			...
			>
			<a
				href="https://www.instagram.com/morningtide.consulting/"
				aria-label="View Morningtide Consulting's Instagram Feed"
				><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 448 512"
					><path
						fill="#ffffff"
